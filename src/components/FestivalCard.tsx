...
export const FestivalCard: React.FC<FestivalCardProps> = ({ data, lang, theme }) => {
  ...
  if (primaryTithiNum === 11 || primaryTithiNum === 26) {
    ...
    observance = {
      ...
      practices: [
        {
          en: "Observe fasting (Upavāsa) or consume fruits & milk",
          hi: "फलाहार अथवा निर्जला/सजला उपवास रखें",
          sa: "उपवासं फलाहारं वा कुर्यात्",
        },
        {
          en: "Chant Viṣṇu Sahasranāma or Hare Kṛṣṇa Mahāmantra",
          hi: "विष्णु सहस्रनाम अथवा ॐ नमो भगवते वासुदेवाय जप",
          sa: "विष्णुसहस्रनामस्तोत्रपाठः",
        },
        {
          en: "Avoid grains, lentils, and negative associations",
          hi: "अन्न व तामसिक भोजन का त्याग",
          sa: "अन्नत्यागः शुद्धाचरणं च",
        },
      ],
      type: "ekadashi",
    };
    ...
    observance = {
      ...
      practices: [
        {
          en: "Perform or listen to Śrī Satyanārāyaṇa Kathā",
          hi: "श्री सत्यनारायण भगवान की कथा व पूजन",
          sa: "सत्यनारायणकथाश्रवणम्",
        },
        {
          en: "Offer Arghya to the Full Moon at moonrise",
          hi: "चन्द्रोदय के समय चन्द्रदेव को अर्घ्य दें",
          sa: "चन्द्राय अर्घ्यप्रदानम्",
        },
        {
          en: "Engage in charity (Dāna) of food, clothes, and lamps",
          hi: "दीपदान, अन्नदान एवं गोसेवा",
          sa: "दीपदानं गोसेवा च",
        },
      ],
      type: "purnima",
    ...
    observance = {
      ...
      practices: [
        {
          en: "Perform Pitṛ Tarpaṇam with water and black sesame seeds",
          hi: "काले तिल और कुशा से पितरों को तर्पण करें",
          sa: "तिलोदकेन तर्पणं कुर्यात्",
        },
        {
          en: "Feed cows, crows, and needy persons",
          hi: "गाय, कौवे एवं जरूरतमंदों को भोजन कराएं",
          sa: "गो-वायस-दरिद्रभोजनम्",
        },
        {
          en: "Refrain from starting materialistic business enterprises",
          hi: "नूतन सांसारिक कार्यों की शुरुआत से बचें",
          sa: "सांसारिकारम्भं परिहरेत्",
        },
      ],
      type: "amavasya",
    };
    ...
    observance = {
      ...
      practices: [
        {
          en: "Perform Śiva Abhiṣeka with milk, honey, and Bilva leaves",
          hi: "कच्चे दूध, जल एवं बेलपत्र से शिवलिंग का अभिषेक",
          sa: "बिल्वपत्रैः दुग्धेन च रुद्राभिषेकः",
        },
        {
          en: "Chant Mahāmṛtyuñjaya Mantra or Oṁ Namaḥ Śivāya",
          hi: "महामृत्युंजय मंत्र अथवा ॐ नमः शिवाय जप",
          sa: "महामृत्युञ्जयमन्त्रजपः",
        },
        {
          en: "Observe fasting until evening pūjā concludes",
          hi: "सायंकाल पूजनोपरांत सात्विक पारण",
          sa: "सन्ध्याकालं यावत् उपवासः",
        },
      ],
      type: "pradosham",
    };
    ...
    observance = {
      ...
      practices: [
        {
          en: "Offer 21 Dūrvā grass blades and Modakas to Ganesha",
          hi: "गणेश जी को २१ दूर्वा दल व मोदक अर्पित करें",
          sa: "एकविंशतिदूर्वादलैः गणेशार्चनम्",
        },
        {
          en: "Recite Saṅkaṭanāśana Gaṇeśa Stotram",
          hi: "संकटनाशन गणेश स्तोत्र का पाठ करें",
          sa: "संकटनाशनस्तोत्रपठनम्",
        },
      ],
      type: "chaturthi",
    };
    ...
    observance = {
      ...
      practices: [
        {
          en: "Light an oil lamp and offer water & Bilva patra to Shiva",
          hi: "शिवलिंग पर जल, अक्षत व बेलपत्र अर्पण",
          sa: "शिवलिंगे जलाभिषेकः",
        },
        {
          en: "Maintain night meditation or chanting",
          hi: "रात्रि में ध्यान एवं ॐ नमः शिवाय जप",
          sa: "निशि ध्यानं जपानुष्ठानं च",
        },
      ],
      type: "shivaratri",
    };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-stone-200/60 pb-3">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-stone-600 font-sans">{observance.subtitle[lang]}</p>
          </div>
        </div>
      </div>
