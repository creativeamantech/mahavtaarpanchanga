...
export const MoonPhaseVisualizer: React.FC<MoonPhaseVisualizerProps> = ({ data, lang }) => {
  ...
  const getPhaseName = () => {
    ...
    if (primaryTithiNum === 8) {
      return {
        en: "First Quarter (Śukla Aṣṭamī)",
        hi: "शुक्ल अष्टमी (अर्धचन्द्र)",
        sa: "शुक्लार्धचन्द्रः",
      };
    }
    if (primaryTithiNum === 23) {
      return {
        en: "Last Quarter (Kṛṣṇa Aṣṭamī)",
        hi: "कृष्ण अष्टमी (अर्धचन्द्र)",
        sa: "कृष्णार्धचन्द्रः",
      };
    }
    if (primaryTithiNum < 8) {
      ...
      <div className="my-4 flex items-center justify-around gap-4">
        ...
        <div className="space-y-2 text-xs">
          ...
          <div className="rounded-lg bg-stone-800/80 p-2.5 border border-stone-700/60">
            ...
            <span className="text-[10px] text-stone-400 block mt-0.5">Sun in {data.sun_rasi}</span>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-stone-800 pt-3">
        <div className="flex items-center justify-between text-[11px] text-stone-400 mb-1 font-sans">
          ...
          <span className="font-semibold text-amber-300">
            {isSukla
              ? `Day ${primaryTithiNum} of 15 (Śukla)`
              : `Day ${primaryTithiNum - 15} of 15 (Kṛṣṇa)`}
          </span>
