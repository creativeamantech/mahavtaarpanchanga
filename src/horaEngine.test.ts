...
describe("Vedic Hora Engine Live Resolver", () => {
  it("Test A to J - Complete Hora verification", () => {
    ...
    const mockPanchanga: PanchangaResponse = {
      ...
      jd: 0, sunrise_jd: 0, coordinate_mode: "sidereal", coordinate_label: "",
      ayanamsa: null, ayanamsa_key: null, ayanamsa_degrees: null,
      month_system: "amanta", month_system_label: "", samvatsara: "", samvatsara_north: "",
      ayana: "", drik_ayana: "", masa: "", masa_number: 1, is_adhika: false,
      rtu: "", drik_rtu: "", vaara: "", weekday: 1, // 1 = Monday (Moon)
      kali_day: 0, saka_year: 0, kali_year: 0, vikrama_year: 0,
      sunrise: "", sunset: "", moonrise: null, moonrise_status: "", moonset: null, moonset_status: "",
      day_duration: "", rahu_kala: {start:"",end:""}, durmuhurta: [], varjyam: [],
      tithi: [{number: 1, name: "Test"}], nakshatra: [], yoga: [], karana: [],
