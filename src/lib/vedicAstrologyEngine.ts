...
export const PLANETS: Record<string, PlanetDetails> = {
  Sun: {
    name: "Sun",
    dasa_years: 6,
    remedy_food: "Rice cooked with jaggery",
    remedy_donation: "Cow with calf",
  },
  Moon: {
    name: "Moon",
    dasa_years: 10,
    remedy_food: "Rice cooked in milk",
    remedy_donation: "Conch or white cow",
  },
  Mars: {
    name: "Mars",
    dasa_years: 7,
    remedy_food: "Havishya",
    remedy_donation: "Bullock or bull",
  },
  Rahu: {
    name: "Rahu",
    dasa_years: 18,
    remedy_food: "Rice cooked with mustard",
    remedy_donation: "Iron weapons or goat",
  },
  Jupiter: {
    name: "Jupiter",
    dasa_years: 16,
    remedy_food: "Curd and rice",
    remedy_donation: "Yellow clothes or gold",
  },
  Saturn: {
    name: "Saturn",
    dasa_years: 19,
    remedy_food: "Rice cooked with sesame seeds",
    remedy_donation: "Black cow or she-buffalo",
  },
  Mercury: {
    name: "Mercury",
    dasa_years: 17,
    remedy_food: "Paddy cooked in milk",
    remedy_donation: "Gold or silver idol",
  },
  Ketu: {
    name: "Ketu",
    dasa_years: 7,
    remedy_food: "Rice cooked with cereals",
    remedy_donation: "Goat",
  },
  Venus: {
    name: "Venus",
    dasa_years: 20,
    remedy_food: "Rice with ghee",
    remedy_donation: "Horse, white cow, or silver",
  },
};
...
export function generateComprehensiveVedicAnalysis(
  ...
  const taraDasaAnalysis = {
    applicable: false,
    strongest_kendra_planet: null,
    dasa_sequence: [] as any[],
  };
  ...
  if (transitContext) {
    const targetMap = navtaraMapping.find(
      (n) => n.nakshatra_number === transitContext.target_nakshatra_num,
    );
  ...
  if (transitVedha && transitVedha.status === "Active") {
    let deity = "",
      mantra = "",
      donation = "";
    if (transitVedha.base_tara === "Vipat") {
      deity = "Lord Ganesha";
      mantra = "Om Gan Ganapataye Namah";
      donation = "Jaggery (Gud) or Yellow Sweets";
    }
    if (transitVedha.base_tara === "Pratyak") {
      deity = "Goddess Durga";
      mantra = "Durga Saptashati";
      donation = "Salt, Wheat, or Sesame";
    }
    if (transitVedha.base_tara === "Vadha") {
      deity = "Lord Shiva";
      mantra = "Mahamrityunjaya Mantra";
      donation = "Sesame oil, Black clothes";
    }
