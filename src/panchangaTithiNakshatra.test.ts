...
describe("Tithi and Nakshatra Exact boundaries", () => {
  it("Should calculate exact start and end for current Tithi and Nakshatra (Pre-sunrise start)", () => {
    ...
    const res = computePanchangaCustom(loc.latitude, loc.longitude, loc.timezone, "15/09/2026", "amanta", "citra");
  ...
  it("Should remain independent of timezone (Timezone isolation)", () => {
    ...
    const resNY = computePanchangaCustom(loc1.latitude, loc1.longitude, loc1.timezone, "15/09/2026", "amanta", "citra");
    const resLon = computePanchangaCustom(loc1.latitude, loc1.longitude, "Europe/London", "15/09/2026", "amanta", "citra");
